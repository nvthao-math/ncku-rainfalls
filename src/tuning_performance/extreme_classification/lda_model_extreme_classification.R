...
# # file to save
bayes.file <- "/home/bigdata/workspace/project/r/ncku-rainfalls/result/lda_output_extreme_normal.txt"
#
for(i in c(4173702:(2^n.feature-1))){
  ...
  bayes.df <- data.frame(c(i), feature, extreme.acc, normal.acc, bayes.acc)
