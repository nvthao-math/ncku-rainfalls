# description 
# bayes: 
# "feature":"P8_z, R500, P_z, P850, R850, P5_v"
# "extreme.acc":0.5875,"normal.acc":0.9727,"bayes.acc":0.9607
# load library
library(kernlab)
library(jsonlite)
library(caret)
...
#
bayes.file <- "/home/bigdata/workspace/project/r/ncku-rainfalls/result/bayes_output_extreme_normal.txt"
#
