...
#
bayes.file <- "/home/bigdata/workspace/project/r/ncku-rainfalls/result/svm_output_extreme_normal.txt"
#
for(i in c(33553408:(2^n.feature-1))){
  x.bi <- as.binary(i, n=(ncol(data.tuning) -1))
  ...
  line <- toJSON(df)
  print(line)
  write(line,file=bayes.file,append=TRUE)
}
